    ...
    public class EmployeesController : Controller
    {
        ...
        public ActionResult LoadData(int LocationId = 0)
        {
            try
            {
                ...
                EmployeesData = SortEmployeesData(EmployeesData, sortColumn, sortColumnDir);
        ...
        private IQueryable<ApplicationUser> SortEmployeesData(IQueryable<ApplicationUser> EmployeesData, string sortColumn, string sortColumnDir)
        {
